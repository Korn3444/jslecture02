//Identifier คือ ชื่อที่ DEV ตั้งขึ้นมาเอง (ตัวแปร, ฟังก์ชัน, คลาส, ค่าคงที่, ออปเจ็กต์) ต้องเป็นไปตามกฏการตั้งชื่อ
//- ไม่เว้นวรรค ไม่ขึ้นต้นด้วยตัวเลข ไม่ใช้คำสงวน/คำสัญ(reserver word/keyword)
//- ไม่ใช่สัญลักษณ์พิเศษ ยกเว้น _ , $
//- ควรตั้งเป็น Pascal Case, Camel Case, Snake Case
//-   StudentScore, studentScore, student_score/STUDENT_SCORE

// Code Block คือ ขอบเขตการทำงานของโปรแกรม
